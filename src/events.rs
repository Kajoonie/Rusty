...
async fn music_component_interaction(ctx: &Context, component: &mut ComponentInteraction) {
    if let Err(e) = component_handlers::handle_interaction(ctx, component).await {
